...
mixin _$LoginPageStore on _LoginPageStoreBase, Store {
  ...
  final _$onErrorMessageAtom = Atom(name: '_LoginPageStoreBase.onErrorMessage');

  @override
  String get onErrorMessage {
    _$onErrorMessageAtom.reportRead();
    return super.onErrorMessage;
  }

  @override
  set onErrorMessage(String value) {
    _$onErrorMessageAtom.reportWrite(value, super.onErrorMessage, () {
      super.onErrorMessage = value;
    });
  }
